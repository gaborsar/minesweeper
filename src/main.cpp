...
int main() {
  ...
  auto sdlWindow{SDL_CreateWindow("Minesweeper", SDL_WINDOWPOS_CENTERED,
  ...
  auto renderer{
      std::make_shared<Minesweeper::Renderer>(sdlRenderer, sdlTexture)};
  auto game{std::make_unique<Minesweeper::Game>(renderer, boardWidth,
                                                boardHeight, numberOfMines)};
    ...
    while (SDL_PollEvent(&event)) {
      ...
      case SDL_MOUSEBUTTONDOWN:
        ...
        case SDL_BUTTON_LEFT:
          shouldRender =
              shouldRender || game->OnClick(event.button.x, event.button.y,
